...
from comp_vision.cv_training import BoundingBoxDataset, get_resnet50_model, apply_nms, recover_original_image_dimensions
...
def single_image_classify(dataset, state_dict_file: str | Path, idx: int = 0, plot_transformed=False):
